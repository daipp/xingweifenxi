...
<script type="text/javascript">
	...
	function timeSearch(){//时长
		 ...
		 setTableName();
		  $('#dg2').datagrid({   
		 	    url:'${pageContext.request.contextPath}/reportHotDo/getReportHotUsers/time', 
	...
	function timesSearch(){ //次数
		 ...
		 setTableName();
		  $('#dg1').datagrid({   
		 	    url:'${pageContext.request.contextPath}/reportHotDo/getReportHotUsers/times', 
		 	   	queryParams:$.serializeObject($('#searchForm')),		 	    			
		 	   	pagination :true,
			    pageSize:20,
			    pageList:[10,20,30,40],
